...
def create_model(
    ...
    return Sketch2Im_Model(
        dec=decoder,
        encoder_n_downsample=encoder_n_downsample,
        encoder_n_res=encoder_n_res,
        encoder_input_dim=encoder_input_dim,
        encoder_dim=encoder_dim,
        encoder_norm=encoder_norm,
        encoder_activ=encoder_activ,
        encoder_pad_type=encoder_pad_type
    )
