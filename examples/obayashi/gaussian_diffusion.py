...
def get_named_beta_schedule(schedule_name, num_diffusion_timesteps, beta_start, beta_end):
    ...
    elif schedule_name == "squaredcos_cap_v2": #not yet using passed in beta_start, beta_end
...
class GaussianDiffusion:
    ...
    def p_mean_variance(
        ...
        # model_output = model(x, self._scale_timesteps(t), **model_kwargs).sample # gives eps and var
    ...
    def training_losses(self, model, x_start, t, vgg, adv, model_kwargs=None, noise=None):
        ...
        if self.loss_type == LossType.KL or self.loss_type == LossType.RESCALED_KL:
            ...
            # model_output = model(x_t, self._scale_timesteps(t), **model_kwargs).sample
