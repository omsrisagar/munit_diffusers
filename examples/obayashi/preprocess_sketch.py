...
if __name__ == '__main__':
    ...
    path = "from_unsplash/images-facade/images-facade/"
    save_path1 = "from_unsplash/images-facade/images-facade_img/"
    save_path2 = "from_unsplash/images-facade/images-facade_sketch/"
    ...
    for file in files:
        ...
        # inimg = PIL.Image.open(full).convert('RGB')
        ...
        inimg.save(os.path.join(save_path1, file.split('.')[0] + '.png'))
        ...
        PIL.Image.fromarray((tenOutput.clip(0.0, 1.0).numpy().transpose(1, 2, 0)[:, :, 0] * 255.0).astype(numpy.uint8)).save(os.path.join(save_path2, file.split('.')[0] + '.png'))
